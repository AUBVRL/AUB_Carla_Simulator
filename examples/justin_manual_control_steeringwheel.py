...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            #JUSTIN
            # spawn_points = self.world.get_map().get_spawn_points()[10]
            spawn_point = self.world.get_map().get_spawn_points()[25]
            # print(spawn_point)
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
        # Set up the sensors.
...
class CameraManager(object):
    def __init__(self, parent_actor, hud):
        ...
        self._camera_transforms = [
            ...
            # (carla.Transform(carla.Location(x=0.28, y=-0.45, z=1.2), carla.Rotation(0,7.5))),
            # (carla.Transform(carla.Location(x=-.18, z=1.3), carla.Rotation(0,180)))
            ]
...
############JUSTIN##########################################
    ...
    #     world = self._parent.get_world()
    #     depth_camera_transform = (carla.Transform(carla.Location(x=0.28, y=-0.45, z=1.2), carla.Rotation(0,55)))
    #     self.depth_camera = world.spawn_actor(self.camera_blueprint(), depth_camera_transform)
...
def game_loop(args):
    ...
    try:
        ...
        #
        # def pickle_dataobject(do):
        #     return world, (do.arg1, do.arg2)
        #
        #
        # packet = pickle.dumps(copyreg.pickle(world, pickle_dataobject))
