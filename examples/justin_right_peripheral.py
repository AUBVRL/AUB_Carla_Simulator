...
class BasicSynchronousClient(object):
	...
	def setup_camera(self):
		...
		camera_transform = (carla.Transform(carla.Location(x=0.28, y=-0.45, z=1.2), carla.Rotation(0,7.5)))
	...
	def setup_depth_camera(self):
		...
		self.depth_camera = self.world.spawn_actor(self.camera_blueprint(), depth_camera_transform, attach_to=self.car)
